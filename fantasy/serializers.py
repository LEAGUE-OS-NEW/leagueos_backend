    ...
    def create(self, validated_data):
        ...
        if existing_participant:
            ...
            while Participant.objects.filter(
                sport=sport, kind=Participant.Kind.ATHLETE, country_code=country_code, slug=slug
            ).exists():
        ...
        fantasy_player = FantasyPlayer.objects.create(
            ...
            availability=validated_data.get("availability", FantasyPlayer.Availability.AVAILABLE),
        )
