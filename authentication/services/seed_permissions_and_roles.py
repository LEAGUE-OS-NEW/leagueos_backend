...
PERMISSIONS = [
    ...
    {"code": "platform.fantasy.manage", "name": "Manage Fantasy", "category": "Fantasy", "scope": Permission.Scope.PLATFORM, "delegatable": True},
    {"code": "platform.fantasy.competitions.manage", "name": "Manage Fantasy Competitions", "category": "Fantasy", "scope": Permission.Scope.PLATFORM, "delegatable": True},
    {"code": "platform.fantasy.players.manage", "name": "Manage Fantasy Players", "category": "Fantasy", "scope": Permission.Scope.PLATFORM, "delegatable": True},
    {"code": "platform.fantasy.scoring.manage", "name": "Manage Fantasy Scoring", "category": "Fantasy", "scope": Permission.Scope.PLATFORM, "delegatable": True},
    {"code": "platform.fantasy.gameweeks.finalize", "name": "Finalize Fantasy Gameweeks", "category": "Fantasy", "scope": Permission.Scope.PLATFORM, "delegatable": True},
...
ROLES = {
    ...
    "Fantasy Admin": {"scope": Role.Scope.PLATFORM, "permissions": ["platform.fantasy.manage", "platform.fantasy.competitions.manage", "platform.fantasy.players.manage", "platform.fantasy.scoring.manage", "platform.fantasy.gameweeks.finalize"]},
