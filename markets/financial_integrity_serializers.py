...
class FeePreviewResponseSerializer(serializers.Serializer):
    ...
    effective_fee_bps = serializers.IntegerField()
    estimated_fee = serializers.DecimalField(max_digits=20, decimal_places=4)
    estimated_total_debit = serializers.DecimalField(max_digits=20, decimal_places=4)
    estimated_net_proceeds = serializers.DecimalField(max_digits=20, decimal_places=4)
